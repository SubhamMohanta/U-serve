            ...
            <Box>
                <Flex justifyContent="center" alignItems="center" >
                    <Flex align="center" justify="space-between" flexDirection={{ base: "column", md: "row" }} m={{ base: "5", md: "15vh 15vw 15vh 10vw" }}>
                        <Image src={img6} w={{ base: "80%", md: "40%" }}  data-aos="fade-zoom-in" />
                        <Box my={{ base: "5", md: "2%" }} textAlign={{ base: "center", md: "end" }} data-aos="fade-zoom-in">
                ...
                <Flex justifyContent="center" alignItems="center">
                    <Flex align="center" justify="space-between" flexDirection={{ base: "column-reverse", md: "row" }} m={{ base: "5", md: "15vh 10vw 15vh 15vw" }}>
                        <Box my={{ base: "5", md: "2%" }} textAlign={{ base: "center", md: "start" }}  data-aos="fade-zoom-in">
                        ...
                        <Image src={img7} w={{ base: "80%", md: "40%" }}  data-aos="fade-zoom-in" />
                    </Flex>
                </Flex>

                <Flex justifyContent="center" alignItems="center">
                    <Flex align="center" justify="space-between" flexDirection={{ base: "column", md: "row" }} m={{ base: "5", md: "15vh 15vw 15vh 10vw" }}>
                        <Image src={img8} w={{ base: "80%", md: "40%" }} data-aos="fade-zoom-in" />
                        <Box my={{ base: "5", md: "2%" }} textAlign={{ base: "center", md: "end" }} data-aos="fade-zoom-in">
