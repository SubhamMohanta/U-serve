...
const HeroContent = () => {
    ...
    return (
        <Box bg={"#FFFEF8"} display="flex" flexDirection="column" justifyContent="center" alignItems="center" color="white" data-aos="fade-zoom-in">
            ...
            <Heading size="2xl" textAlign="center" color="#363636" lineHeight="60px" style={{ marginTop: "-13%" }} >Empowering communities <br />to make a difference</Heading>

            <Text color="#353535" textAlign="center" fontWeight="500" mt={5}>Explore volunteer opportunities. Earn badges, track your<br />impact, and change the world, one good deed at a time.</Text>
